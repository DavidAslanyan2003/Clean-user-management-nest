...
describe('BlogCategoryService', () => {
  ...
  describe('update', () => {
    it('should update a new blog category', async () => {
      const response = await service.updateBlogCategory(updatedMockBlogCategoryDto, mockBlogCategory.id);
      mockBlogCategory = response.data;
  ...
  describe('delete', () => {
    it('should delete the blog category', async () => {
      const response = await service.deleteBlogPostCategory(mockBlogCategory.id);
      mockBlogCategory = response.data;
