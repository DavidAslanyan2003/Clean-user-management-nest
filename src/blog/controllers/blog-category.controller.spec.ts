...
describe('BlogCategoryController', () => {
  ...
  afterAll(async () => {
    if (queryRunner.isTransactionActive) {
      await queryRunner.manager.getRepository(BlogCategory).delete(mockBlogCategory.id);
  ...
  describe('update', () => {
    it('should update a new blog category', async () => {
      const response = await controller.updateCategory(mockBlogCategory.id, updatedMockBlogCategoryDto);
      mockBlogCategory = response.data;
