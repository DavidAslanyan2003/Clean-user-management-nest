...
describe('BlogController', () => {
  ...
  describe('create', () => {
    it('should create a blog', async () => {
      const newBlogCategory = await blogCategoryController.createCategory(mockBlogCategoryDto);
  ...
  describe('updateBlog', () => {
    it('Should update a blog', async () => {
      ...
      const response = await controller.updateBlogPost(mockBlog.id, mockUpdateBlogDto);
      mockBlog = response.data;
  ...
  describe('getBlogsByUserId', () => {
    it('Should return an array of blogs with the same user id', async () => {
      const { created_at, updated_at, ...restOfMockBlog } = mockBlog;
      const response = await controller.getBlogPost(null, null, mockBlog.user_id);
